...
It appears that we have identify `r length(all_anova$anova_BH[all_anova$anova_BH <= 0.05])` significant peptides at 5\% BH FDR. Now, plot the resulting PCA, t-SNE and heatmap of the residual $\log_2$ fluorescence of these peptides.
