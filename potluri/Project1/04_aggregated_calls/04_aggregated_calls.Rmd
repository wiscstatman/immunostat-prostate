...
We also plot the heatmap where we order the columns according to patients' stages instead of the default cluster dendrogram order.

```{r, fig.height = 10, fig.width = 8, fig.show = 'hide', cache = T, dependson=c("anova_dat_demean")}
