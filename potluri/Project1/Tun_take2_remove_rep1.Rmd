...
legend('topright', pch = shp, col = pal, cex = 0.6,
...
The one-way ANOVA is helpful in revealing peptides that exhibit significant difference in the group means of fluorescence levels among different groups of patients. We may be interested to find out which group or groups of patients that actually contribute to the significant difference in antibody responses.  
